package com.gdg.unimatebackend.schedule.service;

import com.gdg.unimatebackend.schedule.dto.*;
import com.gdg.unimatebackend.schedule.entity.MySchedule;
import com.gdg.unimatebackend.schedule.entity.ScheduleCategory;
import com.gdg.unimatebackend.schedule.exception.MyScheduleErrorCodes;
import com.gdg.unimatebackend.schedule.exception.MyScheduleException;
...
public class MyScheduleService {
    ...
    public MyScheduleResponse create(Long userId, Long teamId, MyScheduleCreateRequest request) {
        ...
        ScheduleValidationUtils.validateCategoryRequired(
                ...
                msg -> new MyScheduleException(MyScheduleErrorCodes.INVALID_RANGE, msg, 400)
        );
